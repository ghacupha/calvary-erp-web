...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof io.github.calvary.service.EmailAlreadyUsedException ||
            ex instanceof io.github.calvary.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof io.github.calvary.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "io.github.calvary");
    }
}
