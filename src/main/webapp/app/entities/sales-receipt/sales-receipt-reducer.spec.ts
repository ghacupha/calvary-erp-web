...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALESRECEIPT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SALESRECEIPTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SALESRECEIPT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SALESRECEIPT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SALESRECEIPT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SALESRECEIPT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SALESRECEIPT actions', async () => {
      const expectedActions = [
        {
