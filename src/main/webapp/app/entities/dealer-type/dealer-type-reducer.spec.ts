...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEALERTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DEALERTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DEALERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEALERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEALERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEALERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEALERTYPE actions', async () => {
      const expectedActions = [
        {
