...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSACTIONITEM_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TRANSACTIONITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TRANSACTIONITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSACTIONITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSACTIONITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSACTIONITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSACTIONITEM actions', async () => {
      const expectedActions = [
        {
