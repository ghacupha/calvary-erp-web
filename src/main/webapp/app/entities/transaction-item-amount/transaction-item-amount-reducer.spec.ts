...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './transaction-item-amount.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSACTIONITEMAMOUNT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TRANSACTIONITEMAMOUNTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TRANSACTIONITEMAMOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSACTIONITEMAMOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSACTIONITEMAMOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSACTIONITEMAMOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSACTIONITEMAMOUNT actions', async () => {
      const expectedActions = [
        {
