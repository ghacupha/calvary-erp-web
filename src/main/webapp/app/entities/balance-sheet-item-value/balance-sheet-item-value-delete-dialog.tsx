  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="calvaryErpApp.balanceSheetItemValue.delete.question">
        <Translate contentKey="calvaryErpApp.balanceSheetItemValue.delete.question" interpolate={{ id: balanceSheetItemValueEntity.id }}>
          Are you sure you want to delete this BalanceSheetItemValue?
        </Translate>
      </ModalBody>
      <ModalFooter>
