...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './balance-sheet-item-value.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BALANCESHEETITEMVALUE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_BALANCESHEETITEMVALUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_BALANCESHEETITEMVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BALANCESHEETITEMVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BALANCESHEETITEMVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BALANCESHEETITEMVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BALANCESHEETITEMVALUE actions', async () => {
      const expectedActions = [
        {
