...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './transaction-class.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSACTIONCLASS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TRANSACTIONCLASSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TRANSACTIONCLASS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSACTIONCLASS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSACTIONCLASS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSACTIONCLASS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSACTIONCLASS actions', async () => {
      const expectedActions = [
        {
