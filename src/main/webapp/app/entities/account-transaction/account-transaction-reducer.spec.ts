...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTTRANSACTION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ACCOUNTTRANSACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ACCOUNTTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCOUNTTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCOUNTTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCOUNTTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCOUNTTRANSACTION actions', async () => {
      const expectedActions = [
        {
