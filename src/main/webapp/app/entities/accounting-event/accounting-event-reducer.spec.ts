...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTINGEVENT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ACCOUNTINGEVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ACCOUNTINGEVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCOUNTINGEVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCOUNTINGEVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCOUNTINGEVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCOUNTINGEVENT actions', async () => {
      const expectedActions = [
        {
