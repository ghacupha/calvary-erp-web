...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './transaction-item-entry.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSACTIONITEMENTRY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TRANSACTIONITEMENTRIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TRANSACTIONITEMENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSACTIONITEMENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSACTIONITEMENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSACTIONITEMENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSACTIONITEMENTRY actions', async () => {
      const expectedActions = [
        {
