...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './balance-sheet-item-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BALANCESHEETITEMTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_BALANCESHEETITEMTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_BALANCESHEETITEMTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BALANCESHEETITEMTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BALANCESHEETITEMTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BALANCESHEETITEMTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BALANCESHEETITEMTYPE actions', async () => {
      const expectedActions = [
        {
