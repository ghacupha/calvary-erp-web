...
import { getEntities, reset, searchEntities } from 'app/erp/transaction-item-entry/transaction-item-entry.reducer';
import { Button, Col, Form, FormGroup, Input, InputGroup, Row, Table } from 'reactstrap';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import InfiniteScroll from 'react-infinite-scroll-component';

export const TransactionItemEntryList = ({ transactionItemEntries }) => {
  ...
  return (
    <div>
      ...
      <div className="table-responsive">
        <InfiniteScroll
          dataLength={transactionItemEntries ? transactionItemEntries.length : 0}
          next={handleLoadMore}
          hasMore={paginationState.activePage - 1 < links.next}
          loader={<div className="loader">Loading ...</div>}
        >
          {transactionItemEntries && transactionItemEntries.length > 0 ? (
            <Table responsive>
              <thead>
                <tr>
              ...
              <tbody>
                {transactionItemEntries.map((transactionItemEntry, i) => (
            ...
            !loading && <div className="alert alert-warning">No Transaction Item Entries added</div>
          )}
        </InfiniteScroll>
      </div>
    </div>
...
export default TransactionItemEntryList;
