...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './sales-receipt-title.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALESRECEIPTTITLE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SALESRECEIPTTITLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SALESRECEIPTTITLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SALESRECEIPTTITLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SALESRECEIPTTITLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SALESRECEIPTTITLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SALESRECEIPTTITLE actions', async () => {
      const expectedActions = [
        {
