...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './transfer-item-entry.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSFERITEMENTRY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TRANSFERITEMENTRIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TRANSFERITEMENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSFERITEMENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSFERITEMENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSFERITEMENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSFERITEMENTRY actions', async () => {
      const expectedActions = [
        {
