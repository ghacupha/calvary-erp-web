...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EVENTTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_EVENTTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_EVENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EVENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EVENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EVENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EVENTTYPE actions', async () => {
      const expectedActions = [
        {
